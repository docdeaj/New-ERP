...
@Component({
  ...
  template: `
    <section class="animate-slide-in-spring">
      <h3 class="text-2xl font-bold text-brand-text mb-1">Sales & Invoices</h3>
      <p class="text-charcoal-400 mb-6">Define default behaviors for invoicing and quotations.</p>
...
export class SalesSettingsComponent {
  ...
  settings = computed(() => 
    this.allSettings.filter(s => s.section === 'Sales & Invoices')
  );
}
