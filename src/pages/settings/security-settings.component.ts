...
@Component({
  ...
  template: `
    <section class="animate-slide-in-spring">
      <h3 class="text-2xl font-bold text-brand-text mb-1">Authentication & Security</h3>
      <p class="text-charcoal-400 mb-6">Manage security policies and user authentication settings.</p>
...
export class SecuritySettingsComponent {
  ...
  settings = computed(() => 
    this.allSettings.filter(s => s.section === 'Auth & Security')
  );
}
